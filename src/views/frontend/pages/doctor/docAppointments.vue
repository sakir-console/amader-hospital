      ...
      <div class="container-fluid">
        <div class="row align-items-center">
          <div class="col-md-12 col-12">
            ...
            <h2 class="breadcrumb-title">Patients Appointment</h2>
                          ...
                          <div class="table-responsive">
                            <table class="table table-hover table-center mb-0">
                              ...
                              <tr v-for="(appointment,index) in appointments.data" :key="appointment.id" :value="appointment.id">
                                <td>
                                  <a :href="`/view-profile?user=`+appointment.uid"  class="d-block text-info">    <h2 class="table-avatar">
                               {{appointment.patient}}
...
export default {
  ...
  methods: {
    ...
    appointmentsView() {
      ...
      //request - AH
      this.axios.get("appointment/as_doc?day&schedule&page="+this.page)
          .then(response => {
            this.loading = false;
